...
/* Basic settings. */
$config->version      = '4.2.1';           // The version of ranzhi. Don't change it.
...
define('TABLE_INVOICE',   '`cash_invoice`');

/* Tables for purchase & stock. */
define('TABLE_PURCHASE',     '`sys_purchase`');
define('TABLE_PURCHASEITEM', '`sys_purchaseitem`');
define('TABLE_WAREHOUSE',    '`sys_warehouse`');
define('TABLE_STOCK',        '`sys_stock`');
define('TABLE_STOCKLOG',     '`sys_stocklog`');

/* Tables for CRM enhancement. */
define('TABLE_OPPORTUNITY',    '`crm_opportunity`');
define('TABLE_OPPORTUNITYLOG', '`crm_opportunitylog`');
define('TABLE_FOLLOWUP',       '`crm_followup`');
define('TABLE_QUOTE',          '`crm_quote`');
define('TABLE_QUOTEITEM',      '`crm_quoteitem`');
...
$config->objectTables['purchase']    = TABLE_PURCHASE;
$config->objectTables['warehouse']   = TABLE_WAREHOUSE;
$config->objectTables['stock']       = TABLE_STOCK;
$config->objectTables['invoice']     = TABLE_INVOICE;
$config->objectTables['opportunity'] = TABLE_OPPORTUNITY;
$config->objectTables['followup']    = TABLE_FOLLOWUP;
$config->objectTables['quote']       = TABLE_QUOTE;
